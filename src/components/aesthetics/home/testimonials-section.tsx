...
const REVIEWS = [
  {
    ...
    name: "Tina A.",
    text: "I was honestly skeptical at first, but Aesthetics completely changed how I shop. Every collection feels personal and thoughtful.",
  },
  {
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="aes-joy-scroll mt-12 -mx-4 px-4 sm:-mx-6 sm:px-6">
          {REVIEWS.map((review) => (
            <blockquote
              key={review.name}
              className="w-[280px] shrink-0 rounded-2xl bg-white/80 p-6 backdrop-blur-sm sm:w-[300px]"
            >
