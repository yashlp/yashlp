...
export function CollectionRow({
  ...
  subtitle = "Room-ready edits styled to work together — fewer decisions, more atmosphere.",
}: {
    ...
    <section className="bg-white px-4 py-16 sm:px-6 sm:py-20">
      <div className="mx-auto max-w-7xl">
        <div className="mb-10 text-center">
          ...
          <p className="mx-auto mt-4 max-w-lg text-sm text-[var(--aes-ink-muted)]">{subtitle}</p>
        </div>
